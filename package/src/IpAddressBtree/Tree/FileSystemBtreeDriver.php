...
class FileSystemBtreeDriver implements BtreeDriverInterface
{
    ...
    const SIZEOF_NODE_TYPE = 2;

    const NODE_TYPE_VALUE = 'kv';

    const NODE_TYPE_POINTER = 'kp';

    const NODE_CACHE_SIZE = 64;
